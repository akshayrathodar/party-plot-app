...
@section('title', 'Home - Party Plot Listing Platform')
...
<!-- home3 Banner Section Start-->
                        ...
                        <div class="banner-content-wrap">
                            <div class="container">
                                <div class="banner-content">
                                    <h1>We're ALL-in-one Party Plot Platform</h1>
                                    <p>Discover the best party plots, banquet halls, and event venues for your special occasions. Book with ease and convenience.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="banner-content-wrap">
                            <div class="container">
                                <div class="banner-content">
                                    ...
                                    <p>Every venue is backed by care, quality, and confidence.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="filter-wrapper mb-100">
        <div class="container">
            ...
            <div class="filter-input-wrap">
                <form class="filter-input show" method="GET" action="{{ route('party-plots.index') }}" id="home-search-form">
                    <input type="hidden" name="city" id="selected-city" value="">
                    <input type="hidden" name="category" id="selected-category" value="">
                    <input type="hidden" name="name" id="selected-name" value="">
                    <div class="single-search-box">
                        ...
                        <div class="custom-select-dropdown">
                            <input type="text" name="name" id="party-plot-name" placeholder="Search Venue Name" value="{{ request('name') }}">
                        </div>
                    </div>
                    <div class="single-search-box">
                        <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="custom-select-dropdown destination-dropdown">
                            <input type="text" readonly value="Select Location" id="location-display">
                            <div class="input-field-value">
                                <div class="destination">
                                    <h6 id="location-name">Select Location</h6>
                                    <span id="location-state">India</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single-search-box">
                        ...
                        <div class="custom-select-dropdown">
                            <input type="text" readonly value="Select Category" id="category-display">
                            <span>Category</span>
                        </div>
                        <div class="custom-select-wrap two">
                            <ul class="option-list">
                                @foreach($categories as $category)
                                <li class="single-item" data-category-id="{{ $category->id }}" data-category-name="{{ $category->name }}">
                                    <h6>{{ $category->name }}</h6>
                                </li>
                                @endforeach
                            </ul>
                        ...
                        <div class="custom-select-wrap">
                            ...
                            <ul class="option-list visa-list">
                                <li>
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-bd-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-indo-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-nepal-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-india-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-brazil-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-thailand-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-spain-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-uae-flag.png') }}" alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="destination">
                                    ...
                                    <div class="flag">
                                        <img src="{{ asset('theme/assets/img/home1/filter-usa-flag.png') }}" alt="">
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <p>Add Your Requirements and Party Plot Owners will Contact you.</p>
            </div>
        </div>
    </div>
            ...
            <div class="service-wrapper">
                <div class="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="col-lg-9">
                        <div class="section-title">
                            <h2>We’re Providing Best Venues Ever!</h2>
                ...
                <ul class="service-list wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <li class="single-service">
                        ...
                        <div class="content">
                            <h4>Nearby Venues</h4>
                            <p>Find nearby venues for your event with ease.</p>
                        </div>
                    </li>
                    <li class="single-service">
                        <div class="icon">
                    ...
                    <li class="single-service">
                        ...
                        <div class="content">
                            <h4>Saves Time for Finding the Perfect Venue</h4>
                            <p>Save time by finding the perfect venue for your event with our easy-to-use search and filter options.</p>
                        </div>
                    </li>
                </ul>
                <div class="bottom-area d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="batch">
                        ...
                        <a href="{{ route('party-plots.index') }}">Check Details
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-card2">
                                <a href="{{ route('party-plots.index', ['city' => 'Rajkot']) }}" class="destination-img">
                                    <img src="{{ asset('assets/cities/rajkot.jpg') }}" alt="Rajkot">
                                </a>
    ...
    <div class="home1-offer-section mb-100">
        <div class="container">
            ...
            <div class="swiper home1-offer-slider mb-40">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a href="travel-package-01.html"><img src="{{ asset('theme/assets/img/home1/home1-offer-img1.jpg') }}" alt=""></a>
                    </div>
                    <div class="swiper-slide">
                        <a href="travel-package-details.html"><img src="{{ asset('theme/assets/img/home1/home1-offer-img2.jpg') }}" alt=""></a>
                    </div>
                    <div class="swiper-slide">
                        <a href="travel-package-01.html"><img src="{{ asset('theme/assets/img/home1/home1-offer-img3.jpg') }}" alt=""></a>
                    </div>
                    <div class="swiper-slide">
                        <a href="travel-package-details.html"><img src="{{ asset('theme/assets/img/home1/home1-offer-img4.jpg') }}" alt=""></a>
                    </div>
                    <div class="swiper-slide">
                        <a href="travel-package-details.html"><img src="{{ asset('theme/assets/img/home1/home1-offer-img5.jpg') }}" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <ul class="nav nav-pills" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-europe-tab" data-bs-toggle="pill" data-bs-target="#pills-europe" type="button" role="tab" aria-controls="pills-europe" aria-selected="true">Europe</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-asia-tab" data-bs-toggle="pill" data-bs-target="#pills-asia" type="button" role="tab" aria-controls="pills-asia" aria-selected="false">Asia</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-middle-east-tab" data-bs-toggle="pill" data-bs-target="#pills-middle-east" type="button" role="tab" aria-controls="pills-middle-east" aria-selected="false">Middle East</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-africa-tab" data-bs-toggle="pill" data-bs-target="#pills-africa" type="button" role="tab" aria-controls="pills-africa" aria-selected="false">Africa</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-north-america-tab" data-bs-toggle="pill" data-bs-target="#pills-north-america" type="button" role="tab" aria-controls="pills-north-america" aria-selected="false">North America</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-oceania-tab" data-bs-toggle="pill" data-bs-target="#pills-oceania" type="button" role="tab" aria-controls="pills-oceania" aria-selected="false">Oceania</button>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="swiper home1-destination-slider mb-40">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="destination-card">
                                    <a href="destination-details.html" class="destination-img">
                                        <img src="{{ asset('theme/assets/img/home1/destination-img2.jpg') }}" alt="">
                                    </a>
                                    <div class="destination-content">
                                        <a href="destination-details.html" class="title-area">
                                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="swiper-slide">
                                <div class="destination-card">
                                    <a href="destination-details.html" class="destination-img">
                                        <img src="{{ asset('theme/assets/img/home1/destination-img3.jpg') }}" alt="">
                                    </a>
                                    <div class="destination-content">
                                        <a href="destination-details.html" class="title-area">
                                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="swiper-slide">
                                <div class="destination-card">
                                    <a href="destination-details.html" class="destination-img">
                                        <img src="{{ asset('theme/assets/img/home1/destination-img4.jpg') }}" alt="">
                                    </a>
                                    <div class="destination-content">
                                        <a href="destination-details.html" class="title-area">
                                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="swiper-slide">
                                <div class="destination-card">
                                    <a href="destination-details.html" class="destination-img">
                                        <img src="{{ asset('theme/assets/img/home1/destination-img5.jpg') }}" alt="">
                                    </a>
                                    <div class="destination-content">
                                        <a href="destination-details.html" class="title-area">
                                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="swiper-slide">
                                <div class="destination-card">
                                    <a href="destination-details.html" class="destination-img">
                                        <img src="{{ asset('theme/assets/img/home1/destination-img6.jpg') }}" alt="">
                                    </a>
                                    <div class="destination-content">
                                        <a href="destination-details.html" class="title-area">
                                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper home1-destination-slider mb-40">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="destination-card">
                                    <a href="destination-details.html" class="destination-img">
                                        <img src="{{ asset('theme/assets/img/home1/destination-img1.jpg') }}" alt="">
                                    </a>
                                    <div class="destination-content">
                                        <a href="destination-details.html" class="title-area">
                                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="row gy-lg-5 gy-4">
                    ...
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="travel-package-details.html" class="package-img">
                                <img src="{{ asset('theme/assets/img/home1/tour-package-img1.jpg') }}" alt="">
                            </a>
                            <div class="batch">
                                <span>Hot Sale!</span>
                            </div>
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img2.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img10.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img11.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="travel-package-details.html" class="package-img">
                                <img src="{{ asset('theme/assets/img/home1/tour-package-img3.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="package-content">
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img4.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img13.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img14.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="travel-package-details.html" class="package-img">
                                <img src="{{ asset('theme/assets/img/home1/tour-package-img5.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="package-content">
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img6.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img15.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img16.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row gy-md-5 gy-4">
                        ...
                        <div class="package-img-wrap">
                            <div class="swiper package-card-img-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img7.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img17.jpg') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="travel-package-details.html" class="package-img">
                                            <img src="{{ asset('theme/assets/img/home1/tour-package-img18.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="travel-package-details.html" class="package-img">
                                <img src="{{ asset('theme/assets/img/home1/tour-package-img8.jpg') }}" alt="">
                            </a>
                            <div class="batch">
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="package-card">
                        <div class="package-img-wrap">
                            <a href="travel-package-details.html" class="package-img">
                                <img src="{{ asset('theme/assets/img/home1/tour-package-img9.jpg') }}" alt="">
                            </a>
                            <div class="batch">
    ...
    <div class="home1-location-search-section mb-100">
        <div class="container">
            ...
            <div class="partner-wrap">
                <div class="marquee">
                    <div class="marquee__group">
                        <a href="index.html#"><img src="{{ asset('theme/assets/img/home1/partner-01.png') }}" alt=""></a>
                        <a href="index.html#"><img src="{{ asset('theme/assets/img/home1/partner-02.png') }}" alt=""></a>
                        <a href="index.html#"><img src="{{ asset('theme/assets/img/home1/partner-03.png') }}" alt=""></a>
                        <a href="index.html#"><img src="{{ asset('theme/assets/img/home1/partner-04.png') }}" alt=""></a>
                        <a href="index.html#"><img src="{{ asset('theme/assets/img/home1/partner-05.png') }}" alt=""></a>
                        <a href="index.html#"><img src="{{ asset('theme/assets/img/home1/partner-06.png') }}" alt=""></a>
                    </div>
                                    ...
                                    <div class="package-img-wrap">
                                        <div class="swiper package-card-img-slider">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('theme/assets/img/home1/tour-package-img19.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('theme/assets/img/home1/tour-package-img20.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="package-img-wrap">
                                        <div class="swiper package-card-img-slider">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('theme/assets/img/home1/tour-package-img12.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('theme/assets/img/home1/tour-package-img21.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="swiper-slide">
                                                    <a href="travel-package-details.html" class="package-img">
                                                        <img src="{{ asset('theme/assets/img/home1/tour-package-img22.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="testimonial-card">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('theme/assets/img/home1/testimonial-author-img1.png') }}" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card two">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('theme/assets/img/home1/testimonial-author-img2.png') }}" alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>Selina Henry</h5>
                                            <span>GoFly Traveler</span>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('theme/assets/img/home1/testimonial-author-img3.png') }}" alt="">
                                            <a data-fancybox="video-player" href="https://www.youtube.com/watch?v=MLpWrANjFbI" class="play-btn">
                                                <svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="13" cy="13" r="12.5" fill="white" stroke="#110F0F" />
                                                    <g>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('theme/assets/img/home1/testimonial-author-img4.png') }}" alt="">
                                            <a data-fancybox="video-player" href="https://www.youtube.com/watch?v=MLpWrANjFbI" class="play-btn">
                                                <svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="13" cy="13" r="12.5" fill="white" stroke="#110F0F" />
                                                    <g>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-card two">
                                    <div class="author-area">
                                        <div class="author-img">
                                            <img src="{{ asset('theme/assets/img/home1/testimonial-author-img5.png') }}" alt="">
                                        </div>
                                        <div class="author-info">
                                            <h5>Amber Lashley</h5>
                                            <span>GoFly Traveler</span>
            ...
            <div class="review-wrap wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="tripadvisor-rating-area">
                    <a href="https://www.tripadvisor.com/" class="tripadvisor-rating">
                        <img src="{{ asset('theme/assets/img/home1/icon/tripadvisor-logo.svg') }}" alt="">
                        <div class="rating-area">
                            <span>Reviews</span>
                            <img src="{{ asset('theme/assets/img/home1/icon/tripadvisor-start.svg') }}" alt="">
                        </div>
                    </a>
                ...
                <a href="http://trustpilot.com/" class="trustpilot-rating-area">
                    ...
                    <div class="trustpilot-rating">
                        <img src="{{ asset('theme/assets/img/home1/icon/trustpilot-logo.svg') }}" alt="">
                        <div class="rating-area">
                            <img src="{{ asset('theme/assets/img/home1/icon/trustpilot-star.svg') }}" alt="">
...
<script>
    $(document).ready(function() {
        ...
        $('.option-list-destination li').on('click', function() {
            ...
            const cityName = $(this).find('h6').text();

            $('#selected-city').val(city);
            $('#location-display').val(cityName);
            $('#location-name').text(cityName);
            $('#location-state').text('India');

            // Update dropdown display
            $('.destination-dropdown').addClass('active');
            $('.custom-select-wrap').removeClass('show');
        });

        // Handle category selection
        $('.option-list .single-item').on('click', function() {
            const categoryId = $(this).data('category-id');
            const categoryName = $(this).data('category-name');

            $('#selected-category').val(categoryId);
            $('#category-display').val(categoryName);
            $('.custom-select-dropdown:has(#category-display)').addClass('active');
            $('.custom-select-wrap.two').removeClass('show');
        });

        // Handle form submission
        $('#home-search-form').on('submit', function(e) {
            // Get party plot name value
            const nameValue = $('#party-plot-name').val();
            if (nameValue) {
                $('#selected-name').val(nameValue);
            }
            // Form will submit with hidden inputs containing name, city and category
            // If no values selected, they will be empty and won't filter
            return true;
        });
        ...
        $('#location-search').on('keyup', function() {
            ...
            $('.option-list-destination li').each(function() {
                const cityName = $(this).find('h6').text().toLowerCase();
