...
<!-- home1 Banner Section Start-->
    <div class="home1-banner-section">
        <div class="banner-video-area">
            <video autoplay loop muted playsinline src="{{ asset('theme/assets/video/home1-banner-video.mp4') }}"></video>
        </div>
                                    ...
                                    <ul class="guest-count">
                                        <li class="single-item">
                                            ...
                                            <div class="quantity-counter">
                                                <a href="index.html#" data-type="adult" class="guest-quantity__minus"><i class="bi bi-dash"></i></a>
                                                <input name="adult_quantity" type="text" class="quantity__input"
                                                    value="1">
                                                <a href="index.html#" data-type="adult" class="guest-quantity__plus"><i class="bi bi-plus"></i></a>
                                            </div>
                                        </li>
                                        <li class="single-item">
                                            <div class="title">
                                            ...
                                            <div class="quantity-counter">
                                                <a href="index.html#" data-type="child" class="guest-quantity__minus"><i class="bi bi-dash"></i></a>
                                                <input name="child_quantity" type="text" class="quantity__input"
                                                    value="0">
                                                <a href="index.html#" data-type="child" class="guest-quantity__plus"><i class="bi bi-plus"></i></a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
