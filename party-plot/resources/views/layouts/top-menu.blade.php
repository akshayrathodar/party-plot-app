    ...
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"> <img class="img-fluid for-light"
                        src="{{ getCompanyLogo() }}" alt="{{ getSetting('company_name', 'Company') }}" style="max-height: 40px; max-width: 200px; object-fit: contain;"><img class="img-fluid for-dark"
                        src="{{ getCompanyLogo() }}" alt="{{ getSetting('company_name', 'Company') }}" style="max-height: 40px; max-width: 200px; object-fit: contain;"></a></div>
        ...
        <form class="col-sm-4 form-inline search-full d-none d-xl-block" action="index.html#" method="get">
                        ...
                        <ul>
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 img-50"
                                    ...
                                    <div class="close-circle"><a class="bg-primary" href="index.html#"><i
