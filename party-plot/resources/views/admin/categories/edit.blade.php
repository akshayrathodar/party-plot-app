...
@section('content')
<x-top-header title="Edit Category" />
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="mb-0">
                                <i class="fa fa-edit me-2"></i>Edit Category: {{ $category->name }}
                            </h5>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    This category has <strong>{{ $category->partyPlots()->count() }}</strong> party plot(s) assigned.
                                    @if($category->partyPlots()->count() > 0)
                                        <br><small class="text-muted">Note: You cannot delete this category while it has associated party plots.</small>
                                    @endif
                                </div>
                            </div>
                        </div>
