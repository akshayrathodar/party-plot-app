...
@section('content')
<x-top-header title="Edit SEO Link" />
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="mb-0">
                                <i class="fa fa-edit me-2"></i>Edit SEO Link
                            </h5>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="row">
                            <div class="col-md-6">
                                <strong><i class="fa fa-link"></i> Current URL:</strong> 
                                <code>/venues/{{ $seoLink->slug }}</code>
                            </div>
                            <div class="col-md-6">
                                <strong><i class="fa fa-building"></i> Matching Venues:</strong> 
                                <span class="badge badge-info">{{ $seoLink->venue_count }}</span>
                            </div>
                        </div>
                    </div>

                    <form action="{{ route('admin.seo-links.update', $seoLink->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="link_type" id="link_type" class="form-select @error('link_type') is-invalid @enderror" required>
                                        @foreach($linkTypes as $value => $label)
                                            <option value="{{ $value }}" {{ old('link_type', $seoLink->link_type) === $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="city" id="city" class="form-select @error('city') is-invalid @enderror">
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{ $city }}" {{ old('city', $seoLink->city) === $city ? 'selected' : '' }}>
                                                {{ $city }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="area" id="area" class="form-select @error('area') is-invalid @enderror">
                                        ...
                                        @foreach($areas as $area)
                                            <option value="{{ $area }}" {{ old('area', $seoLink->area) === $area ? 'selected' : '' }}>
                                                {{ $area }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" id="category_id" class="form-select @error('category_id') is-invalid @enderror">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('category_id', $seoLink->category_id) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3" id="tagsField" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <select name="tags[]" id="tags" class="form-select @error('tags') is-invalid @enderror" multiple>
                                        @php
                                            $selectedTags = old('tags', $seoLink->tags ? explode(',', $seoLink->tags) : []);
                                        @endphp
                                        @foreach($tags as $tag)
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="link_text" id="link_text" 
                                           ...
                                           value="{{ old('link_text', $seoLink->link_text) }}" required>
                                    @error('link_text')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_title" id="meta_title" 
                                           ...
                                           value="{{ old('meta_title', $seoLink->meta_title) }}" required>
                                    @error('meta_title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_keywords" id="meta_keywords" 
                                           ...
                                           value="{{ old('meta_keywords', $seoLink->meta_keywords) }}">
                                    @error('meta_keywords')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_description" id="meta_description" rows="2" 
                                              class="form-control @error('meta_description') is-invalid @enderror">{{ old('meta_description', $seoLink->meta_description) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="page_title" id="page_title" 
                                           ...
                                           value="{{ old('page_title', $seoLink->page_title) }}">
                                    @error('page_title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="page_description" id="page_description" rows="3" 
                                              class="form-control @error('page_description') is-invalid @enderror">{{ old('page_description', $seoLink->page_description) }}</textarea>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="sort_order" id="sort_order" 
                                           ...
                                           value="{{ old('sort_order', $seoLink->sort_order) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mt-2">
                                        <input type="checkbox" name="is_active" id="is_active" 
                                               ...
                                               {{ old('is_active', $seoLink->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mt-2">
                                        <input type="checkbox" name="show_on_homepage" id="show_on_homepage" 
                                               class="form-check-input" value="1" 
                                               {{ old('show_on_homepage', $seoLink->show_on_homepage) ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-1"></i> Update SEO Link
                                </button>
