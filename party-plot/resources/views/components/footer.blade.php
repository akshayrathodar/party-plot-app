        ...
        <div class="footer-contact-wrap">
            <div class="inquiry-area">
                ...
                <div class="content">
                    ...
                    <span>Don't hesitate Call to Party Plot Platform.</span>
                </div>
            </div>
            <ul class="contact-area">
                <li class="single-contact">
                    <div class="icon">
                        <img src="{{ asset('theme/assets/img/home1/icon/whatsapp-icon2.svg') }}" alt="">
                    </div>
                    <div class="content">
                        <span>WhatsApp</span>
                ...
                <li class="single-contact">
                    <div class="icon">
                        <img src="{{ asset('theme/assets/img/home1/icon/mail-icon2.svg') }}" alt="">
                    </div>
                    <div class="content">
                        <span>Mail Us</span>
                ...
                <li class="single-contact">
                    <div class="icon">
                        <img src="{{ asset('theme/assets/img/home1/icon/call-icon.svg') }}" alt="">
                    </div>
                    <div class="content">
                        <span>Call Us</span>
            ...
            <div class="row gy-md-4 gy-5">
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="footer-logo-and-addition-info">
                        <a href="{{ route('home') }}" class="footer-logo">
                            <img src="{{ asset('theme/assets/img/footer-logo.svg') }}" alt="Party Plot Platform">
                        </a>
                        <div class="address-area">
                            <span>Party Plot Listing Platform</span>
                            <a href="{{ route('contact') }}">123 Main Street, Rajkot, Gujarat, India</a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-md-end">
                    <div class="footer-widget">
                        ...
                        <ul class="widget-list">
                            <li><a href="#">Party Plot in Rajkot</a></li>
                            <li><a href="#">Party Plot in Kothariya</a></li>
                            <li><a href="#">Party Plot in Ahmedabad</a></li>
                            <li><a href="#">Party Plot in Surat</a></li>
                            <li><a href="#">Party Plot in Vadodara</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="copyright-and-payment-method-area">
                <p>Copyright {{ date('Y') }} <a href="#">Party Plot Platform</a> | All Right Reserved.</p>
            </div>
        </div>
    </div>
</footer>
